...
interface AnalyticsData {
  initialCategoryData: { name: string; value: number }[];
  initialVolumeData: { name: string; volume: number }[];
}

export default function AnalyticsClient({ initialCategoryData, initialVolumeData }: AnalyticsData) {
  return (
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={initialVolumeData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  ...
                  dataKey="value"
                >
                  {initialCategoryData.map((entry, index) => (
