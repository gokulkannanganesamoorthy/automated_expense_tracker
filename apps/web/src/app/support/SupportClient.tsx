...
export default function SupportClient({ initialTickets }: { initialTickets: TicketData[] }) {
  return (
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
              {initialTickets.length > 0 ? (
                ...
                <div className="p-8 text-center text-gray-500">No recent support tickets.</div>
              )}
            </div>
          </div>
        </div>
